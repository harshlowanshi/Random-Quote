...
const dice =[ '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 60.7 28.7 32 64 32l320 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L64 480c-35.3 0-64-28.7-64-64L0 96zm160 64a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM128 288a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm32 64a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM320 192a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm32 64a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM320 384a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg>'  , 
...
const heading=["“Learn as if you will live forever, live like you will die tomorrow.”",
...
const btn= document.querySelector("#btn")
 ...
 const RandomDice =()=>{
    ...
    btn.style.transform="rotate(160deg)"
    const randomnub=  Math.floor(Math.random() * 5);

    h1.innerHTML= heading[randomnub]
    p.innerHTML= para[randomnub]
    btn.innerHTML= dice[randomnub];
    setTimeout(()=>{
